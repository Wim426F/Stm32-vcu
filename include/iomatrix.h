...
class IOMatrix
{
   public://order of these matters! 
      enum pinfuncs
      {
         ...
         COOLANTPUMP, NEGCONTACTOR, BRAKELIGHT, REVERSELIGHT, HEATREQ, HVREQ, DCFCREQUEST, CHARGESTOP,
         BRAKEVACPUMP, COOLINGFAN, HVACTIVE, PARKINGBRAKE, T15ON, PWM_TIM3, CP_SPOOF,
         GS450HOIL, LAST
      };
