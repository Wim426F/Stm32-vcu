...
#define ERROR_MESSAGE_LIST \
   ERROR_MESSAGE_ENTRY(BMS_COMM, ERROR_DISPLAY) \
   ERROR_MESSAGE_ENTRY(GFM_COMM, ERROR_DISPLAY) \
   ERROR_MESSAGE_ENTRY(INV_COMM, ERROR_DISPLAY) \
   ERROR_MESSAGE_ENTRY(i3LIM_COMM, ERROR_DISPLAY) \
   ERROR_MESSAGE_ENTRY(HVCU_COMM, ERROR_DISPLAY) \
   ERROR_MESSAGE_ENTRY(VEHICLE_COMM, ERROR_DISPLAY) \
   ERROR_MESSAGE_ENTRY(CHARGER_COMM, ERROR_DISPLAY) \
   ERROR_MESSAGE_ENTRY(OVERVOLTAGE, ERROR_STOP) \
   ERROR_MESSAGE_ENTRY(ISOLATION, ERROR_STOP) \
